...
See `doc/readme-qt.rst` for instructions on building BitQuark-Qt, the
...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone git@github.com:bitquarkcoin/BitQuark.git BitQuark
        cd BitQuark
...
A bitquarkd binary is not included in the BitQuark-Qt.app bundle. You can ignore
...
on an OS X 10.6 64-bit machine fails. Official release builds of BitQuark-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `BitQuark-Qt.app` is easy:
...
Other commands:
    ...
    ./bitquarkd -daemon # to start the bitquark daemon.
